...
val CourseColors = listOf(
    Color(0xFFCBE8BE) to Color(0xFF1A3A10),
    Color(0xFFBDD8F8) to Color(0xFF0A2A5C),
    Color(0xFFE0D0F0) to Color(0xFF2A1050),
    Color(0xFFFFE0C0) to Color(0xFF5A2800),
    Color(0xFFF8D0E0) to Color(0xFF5A1030),
    Color(0xFFC0F0E8) to Color(0xFF0A3A30),
    Color(0xFFFFF3C4) to Color(0xFF5A4000),
    Color(0xFFFFD0D0) to Color(0xFF5A1010)
)
